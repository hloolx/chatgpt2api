...
| `CHATGPT2API_FORCE_IMAGE_URL_RESPONSE` | `false` | 是否强制图片接口返回 URL 并移除响应中的 `b64_json` |
| `CHATGPT2API_DEFAULT_IMAGE_VISIBILITY` | `private` | 图片生成默认可见性：`private` 需要认证，`public` 裸链接可访问 |
